...
Task("restore")
    ...
    .Does(() =>
{
    DotNetRestore("./serilog-enrichers-httprequestlogcontext.sln", new DotNetRestoreSettings
    {
        LockedMode = true,
    });
});
...
{
    DotNetBuild("./serilog-enrichers-httprequestlogcontext.sln", new DotNetBuildSettings
    {
...
Task("pack")
    ...
    .Does(() =>
{
    var releaseNotes = $"https://github.com/MonticolaExplorator/serilog-httprequestlogcontext/releases/tag/v{buildVersion.Version}";

    DotNetPack("./src/Serilog.Enrichers.HttpRequestLogContext/Serilog.Enrichers.HttpRequestLogContext.csproj", new DotNetPackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,
